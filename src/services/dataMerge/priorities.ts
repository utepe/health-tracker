...
const SOURCE_PRIORITY: Record<MetricType, Record<DataSource, number>> = {
  sleep: { garmin: 3, fitbit: 2, apple_health: 1, combined: 0 },
  steps: { apple_health: 3, garmin: 2, fitbit: 1, combined: 0 },
  heart: { garmin: 3, apple_health: 2, fitbit: 1, combined: 0 },
  readiness: { garmin: 3, fitbit: 2, apple_health: 1, combined: 0 },
  stress: { garmin: 3, apple_health: 0, fitbit: 0, combined: 0 },
  trainingLoad: { garmin: 3, apple_health: 0, fitbit: 0, combined: 0 },
  workout: { garmin: 3, apple_health: 2, fitbit: 1, combined: 0 },
};
